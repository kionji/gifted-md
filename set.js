...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~AdWjEolA6THhtmb7apl4", // Add sess Id here especially when deploying on panels else use app.json and .env file...
...
OWNER_NAME: process.env.OWNER_NAME || "🦂★Ꭿ☼︎ℒ☼︎ℒ✩ℰ✫ℕ♫𓃵 ", // Input Yours custom...(Maintain font for Flow)
...
ANTICALL_MSG: process.env.ANTICALL_MSG || "*_★Ꭿ☼︎ℒ☼︎ℒ✩ℰ✫ℕ♫ ĪS ΛŦ ßƐΛSŦ MᎾDƐ ŔĪƓĤŦ ИᎾᏯ ƇΛИŦ ŔƐƇĪƐ√Ɛ YᎾƱŔ ƇΛĿĿ 📞📵 ",
